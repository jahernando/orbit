"""Tests for `views/secretary/ring_today.py` + `ring_next.py` + helper.
...
class TestFormatOffset:
    def test_minutes(self):
        from views.secretary._ring_table import _format_offset
...
class TestCitaAndSuena:
    def test_same_day(self):
        from views.secretary._ring_table import cita_and_suena
...
class TestRingDt:
    def test_basic(self):
        from views.secretary._ring_table import ring_dt
...
class TestRingTodayViewer:
    def test_no_ring_json_message(self, orbit_env):
        from views.secretary import ring_today
...
class TestRingNextViewer:
    def test_no_ring_json_message(self, orbit_env):
        from views.secretary import ring_next
