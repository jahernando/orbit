...
Cada `.md` generado lleva un banner HTML-comment al inicio (`AUTOGEN_BANNER`)
que marca el fichero como derivado: los viewers se regeneran en cada
`orbit dash` / `orbit save`, así que cualquier edición manual se pierde.
...
AUTOGEN_BANNER = (
    "<!-- 🤖 Auto-generated by orbit · regenerated on `orbit dash` / "
    "`orbit save` · do not edit, changes will be lost on next refresh -->\n\n"
)
