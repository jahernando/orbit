"""Tests for core/archive.py — logbook, event, done items, and note archiving."""
...
from core.archive import (
    ...
    _find_stale_notes, _delete_notes, _count_done_agenda, run_archive,
)
...
class TestRunArchive:
    ...
    def test_project_not_found(self, tmp_path):
        with patch("core.archive._find_new_project", return_value=None):
            ret = run_archive(project="nope")
        assert ret == 1
