...
- [x] add NB to access data
- [x] add solution NB for counting exp
- [x] add solution NB for fit exp
...
## 📎 Referencias
- [Repository USC-Fanal-v2](https://github.com/jahernando/USC-Fanal-v2)
